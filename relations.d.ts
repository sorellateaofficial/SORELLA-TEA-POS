...
type DBQueryConfigWithComment<TRelationType extends 'one' | 'many' = 'one' | 'many', TSchema extends TablesRelationalConfig = TablesRelationalConfig, TTableConfig extends TableRelationalConfig = TableRelationalConfig> = (TTableConfig['relations'] extends Record<string, never> ? {} : {
  with?: DBQueryConfigWith<TSchema, TTableConfig['relations']> | undefined;
}) & {
  columns?: DBQueryConfigColumns<GetTableViewFieldSelection<TTableConfig['table']>> | undefined;
  where?: RelationsFilter<TTableConfig, TSchema> | undefined;
